...
const Home = () => {
  ...
  return (
    <div className="w-screen h-screen flex flex-col">
      ...
      <div className="m-auto  relative w-[340px] lg:w-[616px] flex h-[186px] bg-[#FFC0CB] rounded-3xl">
        <div className=" flex flex-col m-auto">
          <span className="w-[300px] lg:w-[559px] h-[58px] lg:h-[63px] flex rounded-[100px] bg-white/50 m-auto">
            <IoPinSharp
              className="fill-[#3A3A3A] m-auto lg:ml-36 ml-6"
              style={{ width: "24px", height: "20px" }}
            />
            <p className="text-center lg:mr-[153px] text-[14px]  text-[#3A3A3A] m-auto mr-8">
              What would you like to do now?
            </p>
          </span>
          <span className="w-[300px] lg:w-[556px] h-[63px] flex pt-5 mx-auto">
            <span
