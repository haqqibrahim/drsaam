...
const Info = () => {
    ...
    return (
      <div className=" flex flex-col  items-center space-y-10">
        ...
        <img
          src={props.img}
          alt="feature"
          className="p-1 pt-4 w-[550px] h-[500px] lg:w-[400px] lg:h-[500px]"
  ...
  return (
    <div className="w-full overflow-x-hidden">
      {/* Navbar */}
      <div className="bg-black w-full h-16 pl-2 px-2 flex justify-between">
        <img
          src={Logo}
          alt="Logo"
          className="p-3 cursor-pointer pt-4 ml-3 h-[80%] w-[22%] lg:w-[8%]"
        />
        <div className="flex space-x-6 p-4">
        <button
            onClick={() => navigate("/Welcome")}
            className="bg-inherit w-[131px] h-[49px] hidden lg:block rounded-full border-2 border-white/40 text-white font-light"
          >
            Get Started
          </button>
      ...
      {/* Header */}
      <div className="relative pb-4 pt-32 lg:pt-0 lg:pb-20 w-screen  h-screen bg-black flex flex-col justify-center  items-center space-y-10">
        <div>
      ...
      {/* Header 2 */}
      <div className="bg-[#F5F5F7] pb-[100px] space-y-16">
        <div>
        ...
        <div>
          <p className="text-center text-black/50  text-[16px]">
            The{" "}
      ...
      <div className="lg:space-x-64 w-full pt-32 lg:flex-row lg:items-start flex flex-col items-center justify-center">
        ...
        <div className="items-center justify-center self-center pt-10 ">
          ...
          <p className="text-center leading-6 lg:text-left px-4 lg:px-0 lg:text-[14px] text-[#7C7C7C] text-[12px] w-[350px] pt-5">
      ...
      <div>
        ...
        <div className="relative flex justify-center items-center">
          <div className="mt-[680px] absolute lg:h-[318px] h-[454px] items-center align-center justify-center bg-[#3a3a3a] w-screen">
            ...
            <div className="flex flex-col lg:flex-row lg:space-x-80 space-y-10 items-center justify-center">
              <a href="mailto:info.omari.ai@gmail.com">
                <div className="justify-center items-center align-center">
                  ...
                  />
                  <p className="text-[#3A3A3A] mt-2 text-[15px] text-center">
                    E-mail
                  </p>
                </div>
              </a>
      ...
      <div className="pb-10 justify-center items-center align-center">
        <div className="pt-[700px] justify-center items-center align-center">
          <div className="flex justify-center items-center align-center">
            {" "}
            <p className="font-semibold text-center">A product of OmariAI</p>
            <img src={Omari} alt="feature" width="40px" height="40px" />
          </div>
          <p className="text-center text-[12px] pt-3">
            Copyright © 2023 Dr.SAAM from OmariAI, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </div>
