        ...
        >
          <div className="pt-2 items-center flex space-x-4">
            ...
            <div className="flex flex-col">
              {" "}
              <span className="text-white">{chats[key]["userInfo"]["displayName"]}</span>
              <span className="text-slate-300 text-sm">{chats[key]["lastMessage"]["text"]}</span>
            </div>
          </div>
        </div>
      )
