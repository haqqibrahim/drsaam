          ...
          if (message.sender === "User") {
            return (
              <div key={message.id} className="flex flex-row-reverse" ref={ref}>
                <div className="max-w-[50%] min-w-[77px] p-3 m-2 rounded-3xl  border border-[#CBE0E6] flex max-h-[100%] bg-white">
            ...
            return (
             <>
              <div key={message.id} ref={ref} className="">
                <div className="max-w-[70%] w-auto inline-block lg:max-w-[550px] lg:max-h-[100%] p-3 m-2 rounded-3xl flex-col max-h-[100%] bg-[#CBE0E6]">
